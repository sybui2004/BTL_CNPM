...
public class ProductFrm extends JFrame implements ActionListener {
    ...
    private ArrayList<Product> currentProductSearch;
    public ProductFrm(Receipt receipt) {
        this.receipt = receipt;
        productDAO = new ProductDAO();
        currentProductSearch = new ArrayList<>();
        initComponents();
    }
    ...
    private void loadAllProducts() {
        ArrayList<Product> products = productDAO.searchProductByName("");
        currentProductSearch.addAll(products);
    ...
    private Product getSelectedProduct() {
        ...
        return currentProductSearch.get(selectedRow);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //     SupplierFrm supplierFrm = new SupplierFrm(receipt.getUser());
